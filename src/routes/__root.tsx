  ...
  return (
    <div className="navbar bg-base-100 shadow-sm sticky top-0 z-50">
      <div className="navbar-start">
        <Link to="/" className="btn btn-ghost normal-case text-xl">Dra. Susana Flores</Link>
      </div>
  ...
  return (
    <footer className="footer bg-base-200 text-base-content p-10">
      ...
      <nav>
        ...
        <a className="link link-hover" href="https://wa.me/5215555555555" target="_blank" rel="noreferrer">WhatsApp</a>
      </nav>
      <nav>
